    ...
    <nav className="fixed w-full bg-white/80 backdrop-blur-md z-50 py-4 shadow-sm">
      <div className="container mx-auto flex justify-between items-center px-4 md:px-6">
        ...
        <div className="hidden md:flex gap-8 items-center">
          ...
          <a href="#for-whom" className="text-gray-700 hover:text-purple-600 transition-colors">
            Для кого
          </a>
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-16 left-0 right-0 bg-white shadow-md p-4 flex flex-col gap-4">
          <a 
            href="#features" 
            className="text-gray-700 hover:text-purple-600 transition-colors py-2 px-4"
